...
const Aboutus = ({ portfolioData }) => {
  ...
  return shouldRender ? (
    <div className="flex flex-col md:flex-row-reverse items-center justify-center min-h-screen -mt-20 md:mt-0 px-6 md:px-20 w-full mx-auto bg-black text-white" id='aboutme'>
      {/* Right Column: Text */}
      ...
      <div className="mb-8 md:mb-0 md:pl-8">
        <img
          src={profileImage}
          alt="Profile"
          className="rounded-lg shadow-lg w-full max-w-[400px] h-auto border border-1"
        />
      </div>
    </div>
  ) : null;
