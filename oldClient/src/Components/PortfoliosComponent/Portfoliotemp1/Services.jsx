...
const Services = ({ portfolioData }) => {
    ...
    return (
        <>
            {shouldRender && (
                <div className="w-full px-10 pt-20" id='service'>
                    <div className='mb-20 w-fit'>
                        <h1 className="text-5xl font-bold text-left md:text-6xl">{portfolioData?.serviceTagline || "Our Services"}</h1>

                    </div>

                    <div className="container grid grid-cols-1 gap-6 px-10 mx-auto md:grid-cols-2 lg:grid-cols-3 md:px-0">
