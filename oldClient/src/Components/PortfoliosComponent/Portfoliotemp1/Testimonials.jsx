...
const Testimonials = ({ portfolioData }) => {
  ...
  return (
    <>
      ...
      {portfolioData?.bulkLinks&&portfolioData?.bulkLinks.length>0&&( <div className="flex px-96 justify-between">
      
      {portfolioData?.bulkLinks.map((link,index)=>{
          return (

            <LinkButtonComponent2 linkName={link.linkName} linkUrl={link.linkUrl} />
          )
