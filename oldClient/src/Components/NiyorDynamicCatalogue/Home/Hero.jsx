...
const Hero = ({ myprofile }) => {
  ...
  return (
    <div
      ref={heroRef}
      className="relative w-full h-80 md:h-screen bg-cover bg-center"
      style={{
    ...
    >
      ...
      >
        ...
        {/* Tagline */}
        <p className="text-xl md:text-2xl mb-6 npf text-[#D4B274] uppercase" style={{letterSpacing:"12px" , wordSpacing:"4px"}}>
