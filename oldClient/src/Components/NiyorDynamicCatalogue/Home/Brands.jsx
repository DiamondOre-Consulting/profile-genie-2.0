...
import img17 from '../../../assets/Niyor/brands/sc.png'
...
const Brands = () => {
 ...
 Brands we have worked with 
        ...
        {/* Grid for brand logos */}
        <div className="grid grid-cols-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-3 gap-x-8 gap-y-10 w-full max-w-6xl px-4">
          {b2.map((logo, index) => (
            <div
              key={index}
              className="flex justify-center items-center hover:scale-105 transition-transform duration-300"
