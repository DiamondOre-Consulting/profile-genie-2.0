  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          "relative p-0 border-none text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-zinc-100 [&:has([aria-selected].day-range-end)]:rounded-r-md dark:[&:has([aria-selected])]:bg-zinc-800",
          props.mode === "range"
        ...
        day_selected:
          " bg-white text-zinc-900 hover:bg-white hover:text-zinc-900 focus:bg-zinc-50 focus:text-zinc-900",
