...
export default function Component() {
  const id = useId();
  return (
    <div className="relative flex w-full items-start gap-2 rounded-lg border border-zinc-200 p-4 shadow-sm shadow-black/5 has-[[data-state=checked]]:border-zinc-950 dark:border-zinc-800 dark:has-[[data-state=checked]]:border-zinc-300">
      <Switch
        id={id}
      ...
      <div className="flex grow items-center gap-3">
        ...
        <div className="grid grow gap-2">
          <Label htmlFor={id}>
            Label{""}
            <span className="text-xs font-normal leading-[inherit] text-zinc-500 dark:text-zinc-400">
              (Sublabel)
            </span>
          </Label>
