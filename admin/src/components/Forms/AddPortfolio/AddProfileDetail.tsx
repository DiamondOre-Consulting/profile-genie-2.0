...
const AddProfileDetail = ({
  ...
  const {
    ...
    defaultValues: { SOS: [{ fullName: "", phoneNumber: undefined }] },
  });
    ...
    <form className="" onSubmit={handleSubmit(onSubmit)} noValidate>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2">
        <div
          ...
          className="relative flex w-full items-start gap-2 rounded-lg border border-red-500 p-3 shadow-sm shadow-black/5 has-[[data-state=checked]]:border-green-600 "
        >
