...
const EditOthersDetail = ({
  ...
  portfolioId: string;
  othersDetail: othersProfileDetail;
}) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      products: {
        ...
        productList:
          othersDetail?.products?.productList &&
          othersDetail?.products?.productList.length > 1
            ? othersDetail?.products?.productList
            : [
                {
                  uniqueId: "",
      ...
      services: {
        ...
        serviceList:
          othersDetail?.services?.serviceList &&
          othersDetail?.services?.serviceList.length > 1
            ? othersDetail?.services?.serviceList
            : [
                {
                  uniqueId: "",
      ...
      brands: {
        ...othersDetail?.brands,
        brandList:
          othersDetail?.brands?.brandList &&
          othersDetail?.brands?.brandList.length > 1
            ? othersDetail?.brands?.brandList
            : [
                {
                  uniqueId: "",
      ...
      bulkLink: {
        ...
        bulkLinkList:
          othersDetail?.bulkLink?.bulkLinkList &&
          othersDetail?.bulkLink?.bulkLinkList.length > 1
            ? othersDetail?.bulkLink?.bulkLinkList
            : [
                {
                ...
                >
                  ...
                  <div>
                    ...
                    <TextEditor
                      ...
                      handleBlur={(value) => {
                        setValue(`services.serviceList.${ind}.detail`, value, {
                          shouldValidate: true,
                        });
                ...
                >
                  ...
                  <div>
                    ...
                    <TextEditor
                      ...
                      handleBlur={(value) => {
                        setValue(`products.productList.${ind}.detail`, value, {
                          shouldValidate: true,
                        });
