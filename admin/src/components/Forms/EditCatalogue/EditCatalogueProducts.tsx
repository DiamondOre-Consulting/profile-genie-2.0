...
const EditCatalogueProducts = ({ setCurrentStep, userName, ownerId, currentStep }: { setCurrentStep: React.Dispatch<React.SetStateAction<number>>, userName: string | undefined, currentStep: number, ownerId: string }) => {
