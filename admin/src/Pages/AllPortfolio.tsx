...
import { useGetAllPortfolioQuery } from "@/Redux/API/PortfolioApi"
import { IconArrowsExchange, IconBrandFacebook, IconBrandInstagram, IconBrandWhatsapp, IconClock, IconEdit, IconEye, IconLink, IconMail, IconPhone, IconTrash, IconX } from "@tabler/icons-react"
                    ...
                    >
                        ...
                        >
                            ...
                            <ul className="text-gray-400 list-disc pl-6">
                                <li>Once deleted, you won&apos;t be able to get it back.</li>
                                <li>Once deleted, you won&apos;t be able to get it back.</li>
                            </ul>
...

            {
                data?.data.map((item: any) => (
                    <button key={item._id} className="group relative min-w-[18rem] sm:w-[22rem]">
                        ...
                        ></div>
                        <div
                            className="relative rounded-xl border border-white/20 bg-gradient-to-b from-gray-900 via-gray-950 to-black p-3 shadow-md"
                        >
                            <div
                            ...
                            <div className="flex items-center justify-evenly gap-4 mt-4 ">
                                ...
                                <div onClick={() => setDeleteModalActive(true)} className="relative cursor-pointer flex size-10 items-center justify-center group/inner">
                                    <div
