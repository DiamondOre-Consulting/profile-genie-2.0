...
const MultipleSelector = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "border-zinc-200 focus-within:border-zinc-950 focus-within:ring-zinc-950/50 has-aria-invalid:ring-red-500/20 dark:has-aria-invalid:ring-red-500/40 has-aria-invalid:border-red-500 relative min-h-[38px] rounded-md border text-sm transition-[color,box-shadow] outline-none focus-within:ring-[3px] has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 dark:border-zinc-800 dark:focus-within:border-zinc-300 dark:focus-within:ring-zinc-300/50 dark:has-aria-invalid:ring-red-900/20 dark:dark:has-aria-invalid:ring-red-900/40 dark:has-aria-invalid:border-red-900",
          {
      ...
      >
        <div className="flex flex-wrap gap-1">
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              "placeholder:text-zinc-500/70 flex-1 bg-transparent outline-hidden disabled:cursor-not-allowed dark:placeholder:text-zinc-400/70",
              {
      ...
      <div className="relative">
        <div
          className={cn(
            "border-zinc-200 absolute top-2 z-10 w-full overflow-hidden rounded-md border dark:border-zinc-800",
        ...
        >
          {open && (
            <CommandList
              className="bg-white text-zinc-950 shadow-lg outline-hidden dark:bg-zinc-950 dark:text-zinc-50"
              onMouseLeave={() => {
