...
const Contact = ({
  ...
  contact: catalogueResponse["data"]["catalogueOwner"];
  bgColor: string;
  fullName: string;
}) => {
  ...
  return (
    <div id="#contact" className="p-2 bg-white sm:p-6 md:p-16">
      <div
        style={{ backgroundColor: lightenColor(bgColor, 0.85) }}
        className="flex flex-col items-center  shadow-md rounded-lg mt-8 p-1.5 "
      >
          ...
          <div className="w-full h-70">
            {contact?.mapLink && (
              <iframe
                ...
                loading="lazy"
                className="w-full h-full sm:rounded-tr-none sm:rounded-l-md rounded-t-md "
              ></iframe>
            )}
          </div>
            ...
            <div className="w-full p-4 rounded-t-xl">
              <div className="mt-1 flex flex-col w-full text-black  bg-[#00b718] shadow-md p-[2px] rounded-sm md:flex-row items-center relative gap-4  mx-auto">
                <div
                  ...
                  className="bg-[#00b718] shadow-md h-9 w-12 cursor-pointer rounded-sm flex right-0.5 items-center justify-center gap-4 z-10 absolute border-green-500"
                >
              ...
              <div className="flex flex-wrap justify-center gap-3 mt-4 md:justify-start"></div>
            </div>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
        ...
        <div className="bg-[#101828] shadow-md p-5 rounded-lg flex items-center gap-4 border-l-6 border-blue-500">
          ...
          <div>
            ...
            <p className="text-gray-100">
              The Vion, PKB 54, Sector 122, Noida 201307
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#101828] shadow-md p-5 rounded-lg flex items-center gap-4 border-l-6 border-green-500">
          ...
          <div>
            ...
            <p className="text-gray-100">
              SCO 29, Sector 18, Gurugram, Haryana 122001
            </p>
          </div>
        </div>
