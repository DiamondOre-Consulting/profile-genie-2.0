...
import { IconArrowUp, IconBrandInstagram, IconMenu, IconShoppingCart, IconX } from '@tabler/icons-react';
                ...
                {menuOpen && (
                    <div className="fixed inset-0 z-10 flex flex-col items-center justify-center bg-black backdrop-blur-sm bg-opacity-80">
                        ...
                        <nav className="mt-10 text-center text-white">
                            <ul className="space-y-6 text-2xl flex flex-col items-center">
                                ...
                                <Link to='product' smooth={true} delay={500} duration={500}>
                                    <a
                                        href="#product"
                                        onClick={() => {
                                            goToHome()
            ...
            <footer className='border-t border-gray-300 mt-4 shadow-[10px_0px_10px_#808080]' style={{ backgroundColor: lightenColor(data?.data?.backgroundColor, 0.85) }}>
                <div className="mx-auto max-w-5xl md:max-w-full  py-4 md:pb-0">
                    <div
                        ...
                        className="flex w-fit mx-auto items-center space-x-2">
                        <img
                            src={data?.data?.logo?.url}
                            alt="Logo"
                            className="w-16 h-16"
