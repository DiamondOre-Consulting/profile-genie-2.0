  ...
  return (
    <section id="contact" className="pt-20">
      <div className="container text-white max-w-[82rem] mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3">
          ...
          >
            ...
            <Link to="" className="px-10 font-semibold hover:underline">
              B-127, Diamondore, Sector 63, Noida
            </Link>
          </div>
          <Link
            to={`tel:+${918750316743}`}
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.40921070659!2d77.37797097550026!3d28.617495275673047!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cef068957c2f1%3A0xe72309664887757f!2sDiamond%20Ore%20Consulting%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1741849131026!5m2!1sen!2sin&theme=dark"
          loading="lazy"
