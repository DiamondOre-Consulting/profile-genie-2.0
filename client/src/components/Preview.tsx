...
const Preview = () => {
    ...
    const { register: previewRegister, watch: previewWatch, handleSubmit, formState: { errors } } = useForm<previewDetail>({
                                        ...
                                        render={({ field }) => (
                                            <div className="grid gap-1">
                                                ...
                                                >
                                                    <RadioGroupItem
                                                        value="male"
                                                        className={`flex items-center justify-center px-4 py-2  text-sm font-semibold transition-colors border rounded-md border-zinc-200 ${field.value === "male" ? "bg-zinc-200 text-black" : "text-zinc-200"
                                                            }`}
                                                    >
                                                    ...
                                                    <RadioGroupItem
                                                        value="female"
                                                        className={`flex items-center justify-center px-4 py-2 text-sm font-semibold transition-colors border rounded-md border-zinc-200 ${field.value === "female" ? "bg-zinc-200 text-black" : "text-zinc-200"
                                                            }`}
                                                    >
                                                        <div className="flex items-center justify-center w-5 h-5 mr-2 ">
                                                            <IconWoman />
                    ...
                    <nav className="bg-[#101828] text-white backdrop-blur-md  top-0 left-0 w-full z-1000  ">
                        <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 py-3 mx-auto">
                            ...
                            <div className="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
                                ...
                                <button onClick={() => setIsOpen(!isOpen)} type="button" className="inline-flex items-center justify-center w-10 h-10 p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-cta" aria-expanded={isOpen}>
