                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {portfolioData?.otherDetails?.services?.serviceList?.map((service, index) => (
                            <div
                                ...
                                className="p-6 transition-shadow duration-300 border border-black rounded-md hover:shadow-lg"
                            >
                                <div className="flex items-center justify-center w-16 h-16 border-0 text-stone-700">
                                ...
                                <h2 className="mt-4 mb-2 text-xl font-bold md:text-2xl">{service?.title || ''}</h2>
                                <p className="text-sm md:text-base" dangerouslySetInnerHTML={{ __html: service?.detail || '' }}></p>
                            </div>
                        ))}
                    </div>
                </div>
