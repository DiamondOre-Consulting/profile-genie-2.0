import { IconBrandInstagram, IconBrandWhatsapp, IconPhoneCalling } from '@tabler/icons-react'
            ...
            <nav className="bg-[#101828] text-white backdrop-blur-md fixed h-16 top-0 left-0 w-full z-1000  ">
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 py-3 mx-auto">
                    ...
                    <div className="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
                        ...
                        <button onClick={() => setIsOpen(!isOpen)} type="button" className="inline-flex items-center justify-center w-10 h-10 p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-600" aria-controls="navbar-cta" aria-expanded={isOpen}>
