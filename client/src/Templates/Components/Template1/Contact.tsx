...
const Contact = ({
  ...
  contact: portfolioResponse["contactData"];
  bulkLinks: portfolioResponse["otherDetails"]["bulkLink"];
  fullName: string;
}) => {
          ...
          <div className="flex flex-col items-center bg-gradient-to-b from-[#101828] to-black shadow-md rounded-lg mt-8 p-1.5 ">
            <div className="flex flex-col items-center w-full mx-auto sm:flex-row">
              ...
              <div className="flex flex-col w-full h-70 my-auto md:min-w-[22rem] md:max-w-[23rem] text-white bg-[#141d2fcb] items-center">
                <h3 className="py-2 font-semibold tracking-wide uppercase">
                  Share Portfolio
                </h3>
                <div className="w-full p-4 rounded-t-xl">
                  ...
                  <div className="flex mt-4 space-x-3">
                    <button
                      ...
                      className="flex items-center justify-center w-full p-2 px-3 text-white bg-green-500 rounded-md cursor-pointer"
                    >
                      <IconBrandWhatsapp />
                    </button>
                    <button
                      onClick={shareOnFacebook}
                      className="flex items-center justify-center w-full p-2 px-3 text-white bg-blue-600 rounded-md cursor-pointer"
                    >
                      <IconBrandFacebook />
                    </button>
                    <button
                      onClick={shareOnTwitter}
                      className="flex items-center justify-center w-full p-2 px-3 text-white bg-black rounded-md cursor-pointer"
                    >
                      <IconBrandX />
                    </button>
                  </div>
                  <div className="flex flex-wrap justify-center gap-3 mt-4 md:justify-start">
                    {contact?.contactCSV && (
                      <Link
                        to={contact?.contactCSV}
                        className="bg-[#0890b21a] flex w-full items-center justify-center gap-1 text-[#0891b2] border border-[#0891b2] border-b-4 font-medium overflow-hidden relative px-2 py-2 rounded-md hover:brightness-150 hover:border-t-4 hover:border-b active:opacity-75 outline-none duration-300 group"
                      >
                ...
                <div key={index} className="flex items-center py-3">
                  {contact?.social?.facebook && (
                    <Link
                      ...
                      className="block p-2 mx-4 duration-300 rounded-md hover:scale-110 bg-neutral-700"
                    >
                      <IconBrandFacebook
                  ...
                  {contact?.social?.otherSocialList &&
            ...
            {Array.isArray(contact?.address) &&
              ...
              contact?.address?.map((item, index) => {
                return (
                  <div
                    key={index}
                    className="bg-[#101828] shadow-md p-5 rounded-lg flex items-center gap-4 border-l-6 border-blue-500"
                  >
